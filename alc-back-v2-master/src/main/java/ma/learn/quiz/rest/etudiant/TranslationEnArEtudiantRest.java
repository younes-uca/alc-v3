...
@RestController
@RequestMapping("/etudiant/TranslateEnAr")
public class TranslationEnArEtudiantRest {
    @Autowired
    ...
    @GetMapping("/ar/fr/{text}")
    public String translationArToFr(@PathVariable String text) throws IOException {
        return translationEnAr.translationArToFr(text);
    }
